...
class PhotosViewController: UIViewController {
    ...
    var blackView: UIView = {
        let blackView = UIView(frame: CGRect(x:0, y: 0, width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.height+100))
    ...
    func addSubview(){
        ...
        blackView.bringSubviewToFront(closeButton)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0, options: .curveEaseInOut, animations: {
            ...
            if UIScreen.main.bounds.width > UIScreen.main.bounds.height {
                ...
                cell.center.x = self.view.safeAreaLayoutGuide.layoutFrame.width / 2
                cell.center.y = self.view.safeAreaLayoutGuide.layoutFrame.height / 2
            } else {
                cell.layer.bounds = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width, height: UIScreen.main.bounds.width)
